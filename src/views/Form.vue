    ...
    <section class="has-background-primary">
        ...
        <section class="container">
            <div class="columns">
                ...
                <div class="column box">
                    <p class="subtitle has-text-black">Información del padre, madre o tutor</p>
                    ...
                    <b-field label="Teléfono" expanded :type="{ 'is-danger': phoneError }">
                        <b-input v-model="phone" minlength="7" validation-message="Introduce un teléfono valido">
                        </b-input>
                    </b-field>
                    <b-field grouped group-multiline>
                        <b-field label="Correo Electrónico" expanded :type="{ 'is-danger': emailError }">
                            <b-input type="email" v-model="email" validation-message="Introduce un correo válido">
                            </b-input>
                        </b-field>
            ...
            <section class="container box">
                <p class="subtitle has-text-black">¿A qué programas desea inscribirse?</p>
                ...
                <div class="buttons container is-centered">
                    <b-button class="has-text-weight-bold" type="is-primary" size="is-medium"
